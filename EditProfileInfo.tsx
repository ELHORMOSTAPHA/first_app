    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>{press}</DialogTrigger>
       {/* <DialogContent
              ...
              className="ml-6 mt-8 min-w-[720px] max-h-[600px] overflow-auto bg-white"
            >
              <DialogHeader>
              ...
              <form className="flex flex-col gap-y-8" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-y-3">
                  ...
                  <div className="flex h-[220px] w-[220px] flex-col items-center justify-center rounded-[24px] bg-[#F4F4F4]">
                    {!isImageSelected ? (
